			...
			<form method="GET">
				...
				<div class="form-group">
					...
					<select id="preco" name="filtros[preco]" class="form-control">
						...
						<option value="50-100" <?php echo ($filtros['preco']=='51-100')?'selected="selected"':''; ?>>R$ 50 - 100</option>
						<option value="100-200" <?php echo ($filtros['preco']=='101-200')?'selected="selected"':''; ?>>R$ 100 - 200</option>
						<option value="200-500" <?php echo ($filtros['preco']=='201-500')?'selected="selected"':''; ?>>R$ 200 - 500</option>
					</select>
				</div>
